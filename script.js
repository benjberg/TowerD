...
const defender1_bullets = new Image();
defender1_bullets.src = './sprites/bullets/defender1_bullets.png'
projectileType.push(defender1_bullets)
const defender2_bullets = new Image();
defender2_bullets.src = './sprites/bullets/defender2_bullets.png';
projectileType.push(defender2_bullets)
...
class Projectile {
    ...
    draw(){
       ...
       if (this.defenderType === 1 ){ 
           ctx.drawImage(defender1_bullets, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width , this.height)
    }
        else if (this.defenderType === 2 ) {
            ctx.drawImage(defender2_bullets, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width , this.height)
        }
    }
}
    ...
    update(){
       ...
       if (this.chosenDefender === 1) {
        ...
        if (this.shooting && this.shootNow){
           let defenderType = this.chosenDefender;
             projectiles.push(new Projectile(this.x + 70, this.y + 10, defenderType));
             this.shootNow = false;
            }
        } 
}
...
function handleLFloatingMessage(){
...
powerUp.src = './sprites/power-up/powerup.png';
class Resource {
    constructor(){
    ...
    draw(){
        ...
        ctx.fillText(this.amount, this.x + 35, this.y + 10);
        ctx.drawImage(powerUp, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width, this.height)
    }
    update() {
        if (frame % 10 === 0) {
            if (this.frameX < this.maxFrame) this.frameX ++;
...
const bG1 = new Image();
bG1.src = './sprites/backGround/bG1.png'
function animate(){
